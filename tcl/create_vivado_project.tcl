...
#
# Generated by Vivado on Wed Sep 22 20:47:50 +0330 2021
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "$origin_dir/hdl/ad9226/ad9226_driver.sv" \
   "$origin_dir/hdl/cjmcu1401/cjmcu1401_driver.sv" \
   "$origin_dir/hdl/sensor_data_acquisition.vhd" \
   "$origin_dir/xdc/top.xdc" \
  ]
  foreach ifile $files {
  ...
  set paths [list \
   ...
   [file normalize "$origin_dir/matlab"] \
  ]
  foreach ipath $paths {
...
proc create_hier_cell_sensor_ss { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 sensor_m_axis
  ...
  # Create instance: sensor_axis_data_fifo, and set properties
  set sensor_axis_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 sensor_axis_data_fifo ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
 ] $sensor_axis_data_fifo
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins sensor_m_axis] [get_bd_intf_pins sensor_axis_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net sensor_data_acquisit_0_m_axi [get_bd_intf_pins sensor_axis_data_fifo/S_AXIS] [get_bd_intf_pins sensor_data_acquisit_0/m_axi]
  ...
  connect_bd_net -net adc_data [get_bd_pins sensor_data_acquisit_0/adc_data] [get_bd_pins sensor_system_ila/probe0]
  connect_bd_net -net adc_data_otr [get_bd_pins sensor_data_acquisit_0/adc_data_otr] [get_bd_pins sensor_system_ila/probe2]
  connect_bd_net -net adc_data_valid [get_bd_pins sensor_data_acquisit_0/adc_data_valid] [get_bd_pins sensor_system_ila/probe1]
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins m_axis_aclk] [get_bd_pins sensor_axis_data_fifo/m_axis_aclk]
  connect_bd_net -net master_clock_1 [get_bd_pins master_clock] [get_bd_pins sensor_axis_data_fifo/s_axis_aclk] [get_bd_pins sensor_data_acquisit_0/master_clock] [get_bd_pins sensor_system_ila/clk]
  connect_bd_net -net one_dout [get_bd_pins one/dout] [get_bd_pins sensor_axis_data_fifo/s_axis_aresetn]
  ...
  connect_bd_net -net sensor_data_acquisit_0_dbg_probe [get_bd_pins sensor_data_acquisit_0/dbg_probe] [get_bd_pins sensor_system_ila/probe3]
...
proc create_hier_cell_dma_ss { parentCell nameHier } {
  ...
  regenerate_bd_layout -hierarchy [get_bd_cells /dma_ss] -layout_string {
   ...
   "Default View_ScaleFactor":"0.813953",
   "Default View_TopLeft":"-377,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DMA_S_AXI -pg 1 -lvl 0 -x 0 -y 110 -defaultsOSRD
preplace port M00_AXI -pg 1 -lvl 4 -x 1090 -y 220 -defaultsOSRD
preplace port SW_S_AXI -pg 1 -lvl 0 -x 0 -y 360 -defaultsOSRD
preplace port to_pl_stream -pg 1 -lvl 4 -x 1090 -y 570 -defaultsOSRD
preplace port to_ps_stream -pg 1 -lvl 0 -x 0 -y 670 -defaultsOSRD
preplace port dma_mm2s_introut -pg 1 -lvl 4 -x 1090 -y 20 -defaultsOSRD
preplace port dma_s2mm_introut -pg 1 -lvl 4 -x 1090 -y 40 -defaultsOSRD
preplace port pl_clk0 -pg 1 -lvl 0 -x 0 -y 150 -defaultsOSRD
preplace port pl_clk0_aresetn -pg 1 -lvl 0 -x 0 -y 230 -defaultsOSRD
preplace port pl_clk3 -pg 1 -lvl 0 -x 0 -y 590 -defaultsOSRD
preplace port pl_clk3_aresetn -pg 1 -lvl 0 -x 0 -y 570 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -x 510 -y 170 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 3 -x 910 -y 220 -defaultsOSRD
preplace inst dma_system_ila -pg 1 -lvl 3 -x 910 -y 770 -defaultsOSRD
preplace inst pl_to_ps_fifo -pg 1 -lvl 1 -x 160 -y 570 -defaultsOSRD
preplace inst ps_to_pl_fifo -pg 1 -lvl 2 -x 510 -y 580 -defaultsOSRD -resize 200 123
preplace inst dma_lb_axis_switch_0 -pg 1 -lvl 3 -x 910 -y 580 -defaultsOSRD
preplace inst axi_clock_converter_0 -pg 1 -lvl 2 -x 510 -y 400 -defaultsOSRD
preplace netloc S00_ARESETN_1 1 0 3 30 480 320 660 730
preplace netloc axi_dma_0_mm2s_introut 1 2 2 710J 20 NJ
preplace netloc axi_dma_0_s2mm_introut 1 2 2 720J 40 NJ
preplace netloc clk_300m_resetn_1 1 0 2 NJ 230 300
preplace netloc mpsoc_ss_pl_clk0 1 0 2 NJ 150 320
preplace netloc sysclk_clk_wiz_clk_300mhz 1 0 3 20 470 310 40 700
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 2 330 300 690
...
preplace netloc from_ps_stream 1 2 1 740 560n
preplace netloc mpsoc_ss_M00_AXI 1 0 2 NJ 110 NJ
preplace netloc to_ps_stream 1 1 2 290 740 NJ
preplace netloc axi_clock_converter_0_M_AXI 1 2 1 710 400n
preplace netloc SW_S_AXI_1 1 0 2 NJ 360 NJ
preplace netloc to_ps_stream_1 1 0 3 NJ 670 NJ 670 750J
preplace netloc dma_lb_axis_switch_0_to_pl 1 3 1 NJ 570
preplace netloc dma_lb_axis_switch_0_to_dma 1 0 4 40 490 280J 500 720J 480 1070
levelinfo -pg 1 0 160 510 910 1090
pagesize -pg 1 -db -bbox -sgen -160 0 1280 860
"
}
  ...
  connect_bd_intf_net -intf_net to_ps_stream_1 [get_bd_intf_pins dma_ss/to_ps_stream] [get_bd_intf_pins sensor_ss/sensor_m_axis]
  ...
  connect_bd_net -net pl_clk3 [get_bd_pins dma_ss/pl_clk3] [get_bd_pins mpsoc_ss/pl_clk3] [get_bd_pins sensor_ss/m_axis_aclk]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-328,-105",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port uart_rtl -pg 1 -lvl 3 -x 900 -y 90 -defaultsOSRD
preplace port ad9226_clk -pg 1 -lvl 3 -x 900 -y 400 -defaultsOSRD
preplace port ad9226_otr -pg 1 -lvl 0 -x 0 -y 400 -defaultsOSRD
preplace port cjmcu1401_clk -pg 1 -lvl 3 -x 900 -y 420 -defaultsOSRD
preplace port cjmcu1401_si -pg 1 -lvl 3 -x 900 -y 440 -defaultsOSRD
preplace port fan_pwm -pg 1 -lvl 3 -x 900 -y 20 -defaultsOSRD
preplace portBus ad9226_data -pg 1 -lvl 0 -x 0 -y 380 -defaultsOSRD
preplace inst dma_ss -pg 1 -lvl 1 -x 230 -y 150 -defaultsOSRD
preplace inst mpsoc_ss -pg 1 -lvl 2 -x 610 -y 140 -defaultsOSRD
preplace inst sensor_ss -pg 1 -lvl 2 -x 610 -y 410 -defaultsOSRD
preplace netloc S00_ARESETN_1 1 0 3 70 260 NJ 260 820
preplace netloc ad9226_data_0_1 1 0 2 NJ 380 NJ
preplace netloc ad9226_otr_0_1 1 0 2 NJ 400 NJ
preplace netloc dma_ss_dma_mm2s_introut 1 1 1 390 140n
preplace netloc dma_ss_dma_s2mm_introut 1 1 1 400 160n
preplace netloc master_clock_1 1 1 2 400 320 850
preplace netloc mpsoc_ss_peripheral_aresetn_pl_clk0 1 0 3 60 280 NJ 280 860
preplace netloc pl_clk0 1 0 3 40 290 NJ 290 840
preplace netloc pl_clk3 1 0 3 50 300 390 300 830
preplace netloc sensor_ss_ad9226_clk_0 1 2 1 NJ 400
preplace netloc sensor_ss_cjmcu1401_clk_0 1 2 1 NJ 420
preplace netloc sensor_ss_cjmcu1401_si_0 1 2 1 NJ 440
preplace netloc to_ps_stream_1 1 0 3 20 310 NJ 310 820
preplace netloc mpsoc_ss_M02_AXI 1 0 3 30 270 NJ 270 870
preplace netloc dma_ss_M00_AXI 1 1 1 N 120
preplace netloc axi_uartlite_0_UART 1 2 1 880J 90n
preplace netloc S_AXI_LITE_1 1 0 3 20 10 NJ 10 880
levelinfo -pg 1 0 230 610 900
pagesize -pg 1 -db -bbox -sgen -190 0 1060 490
"
}
